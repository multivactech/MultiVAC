...
func TestStreamErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{"C0", calls{"List", "Uint"}, nil, ErrEndOfLine},
		{"C8C9010101010101010101", calls{"List", "Kind"}, nil, ErrElemTooLarge},
		{"C3C2010201", calls{"List", "List", "Uint", "Uint", "ListEnd", "Uint"}, nil, ErrEndOfLine},
...
func TestStreamList(t *testing.T) {
	...
	if _, err := s.Uint(); err != ErrEndOfLine {
		t.Errorf("Uint error mismatch, got %v, want %v", err, ErrEndOfLine)
	}
...
var decodeTests = []decodeTest{
	...
	// signed integers
	{input: "80", ptr: new(int32), value: int32(0)},
	{input: "820105", ptr: new(int32), value: int32(5)},
	{input: "83010505", ptr: new(int32), value: int32(0x0505)},
	{input: "8401050505", ptr: new(int32), value: int32(0x050505)},
	{input: "850105050505", ptr: new(int32), error: "rlp: input string too long for int32"},
	{input: "828005", ptr: new(int32), value: int32(-5)},
	{input: "83800505", ptr: new(int32), value: int32(-0x0505)},
	{input: "8480050505", ptr: new(int32), value: int32(-0x050505)},
	{input: "858005050505", ptr: new(int32), error: "rlp: input string too long for int32"},
	{input: "C0", ptr: new(int32), error: "rlp: expected input string or byte for int32"},
	{input: "00", ptr: new(int32), error: "rlp: non-canonical integer (leading zero bytes) for int32"},
	{input: "8105", ptr: new(int32), error: "rlp: non-canonical size information for int32"},
	{input: "83010004", ptr: new(int32), error: "rlp: non-canonical integer (leading zero bytes) for int32"},
	{input: "B8020004", ptr: new(int32), error: "rlp: non-canonical size information for int32"},
	...
	// structs
	{
		input: "CB0583343434828001820109",
		ptr:   new(simplestruct),
		value: simplestruct{5, "444", -1, 9},
	},
	{
		input: "CC0383666F6F82807F83011000",
		ptr:   new(simplestruct),
		value: simplestruct{3, "foo", -127, 4096},
	},
	{
		input: "CA0383666F6F8083011000",
		ptr:   new(simplestruct),
		value: simplestruct{3, "foo", 0, 4096},
	},
	{
