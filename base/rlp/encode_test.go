...
var encTests = []encTest{
	...
	// signed integers
	{val: int32(0), output: "80"},
	{val: int32(1), output: "820101"},
	{val: int32(127), output: "82017F"},
	{val: int32(128), output: "820180"},
	{val: int32(256), output: "83010100"},
	{val: int32(1024), output: "83010400"},
	{val: int32(0x7FFFFFFF), output: "85017FFFFFFF"},
	{val: int64(0x7FFFFFFF), output: "85017FFFFFFF"},
	{val: int64(0xFFFFFFFF), output: "8501FFFFFFFF"},
	{val: int64(0xFFFFFFFFFF), output: "8601FFFFFFFFFF"},
	{val: int64(0xFFFFFFFFFFFF), output: "8701FFFFFFFFFFFF"},
	{val: int64(0xFFFFFFFFFFFFFF), output: "8801FFFFFFFFFFFFFF"},

	{val: int32(-1), output: "828001"},
	{val: int32(-127), output: "82807F"},
	{val: int32(-128), output: "828080"},
	{val: int32(-256), output: "83800100"},
	{val: int32(-1024), output: "83800400"},
	{val: int32(-0x7FFFFFFF), output: "85807FFFFFFF"},
	{val: int64(-0x7FFFFFFF), output: "85807FFFFFFF"},
	{val: int64(-0xFFFFFFFF), output: "8580FFFFFFFF"},
	{val: int64(-0xFFFFFFFFFF), output: "8680FFFFFFFFFF"},
	{val: int64(-0xFFFFFFFFFFFF), output: "8780FFFFFFFFFFFF"},
	{val: int64(-0xFFFFFFFFFFFFFF), output: "8880FFFFFFFFFFFFFF"},
	...
	// structs
	{val: simplestruct{}, output: "C480808080"},
	{val: simplestruct{A: 3, B: "foo", C: -127, D: 4096}, output: "CC0383666F6F82807F83011000"},
