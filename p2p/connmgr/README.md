...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/multivactech/peer-server-test/connmgr)
...
```bash
$ go get -u github.com/multivactech/peer-server-test/connmgr
```
