...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/multivactech/peer-server-test/peer)
...
```bash
$ go get -u github.com/multivactech/peer-server-test/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/multivactech/peer-server-test/peer#example-package--NewOutboundPeer)  
