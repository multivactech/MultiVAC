...
func TestStartStop(t *testing.T) {
	n := addrmgr.New("teststartstop", true, lookupFunc)
...
func TestAddAddressByIP(t *testing.T) {
	...
	amgr := addrmgr.New("testaddressbyip", true, nil)
...
func TestAddLocalAddress(t *testing.T) {
	...
	amgr := addrmgr.New("testaddlocaladdress", true, nil)
...
func TestAttempt(t *testing.T) {
	n := addrmgr.New("testattempt", true, lookupFunc)
...
func TestConnected(t *testing.T) {
	n := addrmgr.New("testconnected", true, lookupFunc)
...
func TestNeedMoreAddresses(t *testing.T) {
	n := addrmgr.New("testneedmoreaddresses", true, lookupFunc)
	addrsToAdd := 1500
...
func TestGood(t *testing.T) {
	n := addrmgr.New("testgood", true, lookupFunc)
	addrsToAdd := 64 * 64
	addrs := make([]*wire.NetAddress, addrsToAdd)
	...
	if numCache > numAddrs {
		t.Errorf("Number of addresses in cache: got %d, want %d", numCache, numAddrs)
	}
}

func TestGetAddress(t *testing.T) {
	n := addrmgr.New("testgetaddress", true, lookupFunc)
...
func TestGetBestLocalAddress(t *testing.T) {
	...
	amgr := addrmgr.New("testgetbestlocaladdress", true, nil)
	...
	for _, localAddr := range localAddrs {
		...
		if err != nil {
			log.Printf("failed to add local address,%v", err)
		}
	}
...
func TestAddrManager_HostToNetAddress(t *testing.T) {
	addressList := []string{
		"asdfqwerzxcvtgbh.onion",
		"192.168.1.12",
		"asdfqwer/xcvtgbh.onion",
		"290.1.1.1",
		"",
		"2333",
	}
	amgr := addrmgr.New("TestAddrManager_HostToNetAddress", true, lookupFun1)
	var port uint16 = 2333
	var service = wire.ServiceFlag(1)
	for _, val := range addressList {
		addr, err := amgr.HostToNetAddress(val, port, service)
		if err != nil {
			log.Println(err)
		} else {
			log.Println(addr.IP)
...
func lookupFun1(s string) ([]net.IP, error) {
	if s == "2333" {
		return []net.IP{
			net.IP{
				127, 1, 1, 1,
...
func TestAddrManager_Start(t *testing.T) {
	addmgr := addrmgr.New("/Users/mac/go/src/github.com/multivactech/MultiVAC/p2p/addrmgr/", true, lookupFun1)
	addmgr.Start()

}

// the following code is just used to write a saved json.
//func TestAddrManager_SavePeers(t *testing.T) {
//	admgr := addrmgr.New("/Users/mac/go/src/github.com/multivactech/MultiVAC/p2p/addrmgr/", false, lookupFun1)
//	err := admgr.AddAddressByIP("192.168.11.12:7576")
//	if err != nil {
//		log.Println("failed to add peer by ip, err:", err)
//	}
//	err = admgr.AddAddressByIP("210.31.32.126:2323")
//	if err != nil {
//		log.Println("failed to add peer by ip, err:", err)
//	}
//	admgr.savePeers()
