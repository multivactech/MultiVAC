...
func TestInvVectWire(t *testing.T) {
	...
	txInvVectEncoded := []byte{
		...
		0xc7, 0x23, 0xda, 0x94, 0x10, 0x69, 0xe9, 0xdc, // Block 203707 hash
	}
	...
	// multivacInvVect is an inventory vector representing a multivac message.
	multivacInvVect := InvVect{
		Type: InvTypeMultiVac,
		Hash: *baseHash,
	}

	// multivacInvVectEncoded is the wire encoded bytes of multivacInvVect.
	multivacInvVectEncoded := []byte{
		0x04, 0x00, 0x00, 0x00, // InvTypeMultiVac
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x26,
		0x4b, 0xc2, 0xac, 0x36, 0xa6, 0x08, 0x40, 0x79,
		0x0b, 0xa1, 0xd4, 0x75, 0xd0, 0x13, 0x67, 0xe7,
		0xc7, 0x23, 0xda, 0x94, 0x10, 0x69, 0xe9, 0xdc, // Block 203707 hash
	...
	tests := []struct {
		...
		// Latest protocol version multivac inventory vector.
		{
			multivacInvVect,
			multivacInvVect,
			multivacInvVectEncoded,
			ProtocolVersion,
		},
		...
		// Protocol version BIP0035Version multivac inventory vector.
		{
			multivacInvVect,
			multivacInvVect,
			multivacInvVectEncoded,
		...
		// Protocol version BIP0031Version multivac inventory vector.
		{
			multivacInvVect,
			multivacInvVect,
			multivacInvVectEncoded,
		...
		// Protocol version NetAddressTimeVersion multivac inventory vector.
		{
			multivacInvVect,
			multivacInvVect,
			multivacInvVectEncoded,
		...
		// Protocol version MultipleAddressVersion multivac inventory vector.
		{
			multivacInvVect,
			multivacInvVect,
			multivacInvVectEncoded,
