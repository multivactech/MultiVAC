...
// The parameters which are pointers indicate they are optional.  Passing nil
// for optional parameters will use the default value.
func NewGetTxOutCmd(hexOutPoint string, includeMempool *bool) *GetTxOutCmd {
	return &GetTxOutCmd{
		HexOutPoint:    hexOutPoint,
...
// PrepareForStopCmd defines the prepareForStop JSON-RPC command.
type PrepareForStopCmd struct{}

// NewPrepareForStopCmd returns a new instance which can be used to
// issue a prepareForStop JSON-RPC command.
func NewPrepareForStopCmd() *PrepareForStopCmd {
	return &PrepareForStopCmd{}
}
...
// TestCmd defines the test JSON-RPC command.
// TODO put these commands into some MultiVAC specific files
// MultiVAC stuff starts
type TestCmd struct {
	Str string
}

// NewTestCmd returns a new instance which can be used to issue a
// test JSON-RPC command.
func NewTestCmd(str string) *TestCmd {
	return &TestCmd{
		Str: str,
	}
}

// TestTxCmd defines the testTx JSON-RPC command.
type TestTxCmd struct {
	NumOfTx string
}

// NewTestTxCmd returns a new instance which can be used to issue a
// testTx JSON-RPC command.
func NewTestTxCmd(str string) *TestTxCmd {
	return &TestTxCmd{
		NumOfTx: str,
	}
}

// TransferTxCmd defines the transferTx JSON-RPC command.
type TransferTxCmd struct {
	TxDetail string
}

// NewTransferTxCmd returns a new instance which can be used to issue a
// transferTx JSON-RPC command.
func NewTransferTxCmd(str string) *TransferTxCmd {
	return &TransferTxCmd{
		TxDetail: str,
	}
}

// QueryBlockCmd defines the queryBlock JSON-RPC command.
type QueryBlockCmd struct {
	StartHeight int64
	ShardID     string
}

// NewQueryBlockCmd returns a new instance which can be used to issue a
// queryBlock JSON-RPC command.
func NewQueryBlockCmd(height int64, shardID string) *QueryBlockCmd {
...
// QuerySlimBlockCmd defines the querySlimBlock JSON-RPC command.
type QuerySlimBlockCmd struct {
	Height    int64
	ShardID   string
	ToShardID string
}

// NewQuerySlimBlockCmd returns a new instance which can be used to issue a
// querySlimBlock JSON-RPC command.
func NewQuerySlimBlockCmd(height int64, shardID string, toShardID string) *QuerySlimBlockCmd {
	return &QuerySlimBlockCmd{
		Height:    height,
		ShardID:   shardID,
		ToShardID: toShardID,
	}
...
// QueryBlockSliceCmd defines the queryBlocksSlice JSON-RPC command.
type QueryBlockSliceCmd struct {
	StartHeight int64
	EndHeight   int64
	ShardID     string
}

// NewQueryBlockSliceCmd returns a new instance which can be used to issue a
// queryBlockSlice JSON-RPC command.
func NewQueryBlockSliceCmd(startHeight int64, endHeight int64, shardID string) *QueryBlockSliceCmd {
	return &QueryBlockSliceCmd{
...
// QuerySlimBlockSliceCmd defines the querySlimBlockSlice JSON-RPC command.
type QuerySlimBlockSliceCmd struct {
	StartHeight int64
	EndHeight   int64
	ShardID     string
	ToShardID   string
...
// NewQuerySlimBlockSliceCmd returns a new instance which can be used to issue a
// querySlimBlockSlice JSON-RPC command.
func NewQuerySlimBlockSliceCmd(startHeight int64,
	endHeight int64, shardID string, toShardID string) *QuerySlimBlockSliceCmd {
	return &QuerySlimBlockSliceCmd{
		StartHeight: startHeight,
		EndHeight:   endHeight,
		ShardID:     shardID,
		ToShardID:   toShardID,
...
type QueryShardInfoCmd struct{}

// HeartBeatStartImd defines ...
type HeartBeatStartImd struct{}

// NewQueryShardInfoCmd returns a new instance which can be used to issue a
// queryShardInfo JSON-RPC command.
func NewQueryShardInfoCmd() *QueryShardInfoCmd {
	return &QueryShardInfoCmd{}
}

// SetHeartBeatTimeCmd defines the setHeartTime JSON-RPC command.
type SetHeartBeatTimeCmd struct {
	Online    int64
	Deviation int64
	Interval  int64
}

// NewSetHeartBeatTimeCmd returns a new instance which can be used to issue a
// setHeartBeatTime JSON-RPC command.
func NewSetHeartBeatTimeCmd(online, deviation, interval int64) *SetHeartBeatTimeCmd {
	return &SetHeartBeatTimeCmd{
		Online:    online,
		Deviation: deviation,
		Interval:  interval,
	}
...
// The parameters which are pointers indicate they are optional.  Passing nil
// for optional parameters will use the default value.
// TODO(liboshen): Once we have a method to infer the shard index from a tx, we can remove `shardIndexNum`.
...
// StartNetCmd defines the startNet JSON-RPC command.
type StartNetCmd struct{}
...
// NewStartNetCmd returns a new instance which can be used to issue a startNet JSON-RPC command.
func NewStartNetCmd() *StartNetCmd {
	return &StartNetCmd{}
}
...
// QuerySmartContractInfoCmd defines the querySmartContractInfo JSON-RPC command.
type QuerySmartContractInfoCmd struct {
	ContractAddress multivacaddress.Address
	ShardIdx        shard.Index
}

// NewQuerySmartContractInfoCmd returns a new instance which can be used to issue a
// querySmartContractInfo JSON-RPC command.
func NewQuerySmartContractInfoCmd(contractAddress multivacaddress.Address, shardIdx shard.Index) *QuerySmartContractInfoCmd {
	return &QuerySmartContractInfoCmd{
...
func init() {
	...
	MustRegisterCmd("test", (*TestCmd)(nil), flags)
	MustRegisterCmd("testtx", (*TestTxCmd)(nil), flags)
	MustRegisterCmd("transfertx", (*TransferTxCmd)(nil), flags)
	MustRegisterCmd("queryshardinfo", (*QueryShardInfoCmd)(nil), flags)
	MustRegisterCmd("queryblock", (*QueryBlockCmd)(nil), flags)
	MustRegisterCmd("queryslimblock", (*QuerySlimBlockCmd)(nil), flags)
	MustRegisterCmd("queryblockslice", (*QueryBlockSliceCmd)(nil), flags)
	MustRegisterCmd("queryslimblockslice", (*QuerySlimBlockSliceCmd)(nil), flags)
	MustRegisterCmd("setheartbeattime", (*SetHeartBeatTimeCmd)(nil), flags)
	MustRegisterCmd("startimmediately", (*HeartBeatStartImd)(nil), flags)
	MustRegisterCmd("querysmartcontractinfo", (*QuerySmartContractInfoCmd)(nil), flags)
	MustRegisterCmd("startnet", (*StartNetCmd)(nil), flags)
}
