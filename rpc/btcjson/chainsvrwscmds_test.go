...
func TestChainSvrWsCmds(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "prepareforstop",
			newCmd: func() (interface{}, error) {
				return btcjson.NewCmd("prepareforstop")
			},
			staticCmd: func() interface{} {
				return btcjson.NewPrepareForStopCmd()
			},
			marshalled:   `{"jsonrpc":"1.0","method":"prepareforstop","params":[],"id":1}`,
			unmarshalled: &btcjson.PrepareForStopCmd{},
		},
	}
