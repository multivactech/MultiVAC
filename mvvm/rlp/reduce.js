...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5278784,
    DYNAMIC_BASE = 5278784,
    DYNAMICTOP_PTR = 35872;
...
var real___Z11reduce_execPhi = asm["__Z11reduce_execPhi"];
asm["__Z11reduce_execPhi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z11reduce_execPhi.apply(null, arguments);
};

var real___Z4execPhi = asm["__Z4execPhi"];
asm["__Z4execPhi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z4execPhi.apply(null, arguments);
};
...
Module["asm"] = asm;
var __Z11reduce_execPhi = Module["__Z11reduce_execPhi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z11reduce_execPhi"].apply(null, arguments)
};

var __Z4execPhi = Module["__Z4execPhi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z4execPhi"].apply(null, arguments)
};
